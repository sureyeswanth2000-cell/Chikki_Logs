...
- [x] Owner earnings page should show owner earnings/revenue received summaries by today, week, month, and custom date without loading all history by default
