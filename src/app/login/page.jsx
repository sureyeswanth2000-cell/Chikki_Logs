    ...
    return (<main className="mx-auto max-w-3xl px-5 py-10 md:px-6 md:py-12">
      <section className="glass-card animate-rise rounded-2xl p-8">
        ...
        <div className="mt-4 rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-xs text-slate-700">
          Trusted flow: OTP/Google auth, role-safe routing, and booking-context return after sign-in.
        </div>
        ...
        <div id="recaptcha-container" className="mt-6"/>
                ...
                <p className="mt-6 text-xs text-slate-500">
                  First booking is easier: Aadhaar is optional, and you can add it later from your profile if you want repeat-booking convenience.
                </p>
